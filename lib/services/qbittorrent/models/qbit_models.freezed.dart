...
mixin _$QbitTorrent {
 ...
 String get hash; String get name; int get size; double get progress; int get dlspeed; int get upspeed; int get priority;@JsonKey(name: 'num_seeds') int get numSeeds;@JsonKey(name: 'num_leechs') int get numLeechs;@JsonKey(name: 'num_incomplete') int get numIncomplete; double get ratio; int get eta; String get state; String get tracker;@JsonKey(name: 'added_on') int get addedOn;@JsonKey(name: 'completion_on') int get completionOn; String get category; String get tags;@JsonKey(name: 'save_path') String get savePath;@JsonKey(name: 'time_active') int get timeActive;@JsonKey(name: 'last_activity') int get lastActivity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,hash,name,size,progress,dlspeed,upspeed,priority,numSeeds,numLeechs,numIncomplete,ratio,eta,state,tracker,addedOn,completionOn,category,tags,savePath,timeActive,lastActivity]);

@override
String toString() {
  return 'QbitTorrent(hash: $hash, name: $name, size: $size, progress: $progress, dlspeed: $dlspeed, upspeed: $upspeed, priority: $priority, numSeeds: $numSeeds, numLeechs: $numLeechs, numIncomplete: $numIncomplete, ratio: $ratio, eta: $eta, state: $state, tracker: $tracker, addedOn: $addedOn, completionOn: $completionOn, category: $category, tags: $tags, savePath: $savePath, timeActive: $timeActive, lastActivity: $lastActivity)';
}
...
/// Create a copy of QbitTorrent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hash = null,Object? name = null,Object? size = null,Object? progress = null,Object? dlspeed = null,Object? upspeed = null,Object? priority = null,Object? numSeeds = null,Object? numLeechs = null,Object? numIncomplete = null,Object? ratio = null,Object? eta = null,Object? state = null,Object? tracker = null,Object? addedOn = null,Object? completionOn = null,Object? category = null,Object? tags = null,Object? savePath = null,Object? timeActive = null,Object? lastActivity = null,}) {
