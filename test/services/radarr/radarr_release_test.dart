// RadarrRelease parsing against a realistic /api/v3/release payload:
// torrent releases carry seeders/leechers; rejections may be plain strings
// (Radarr v3) or {reason,type} objects (newer Radarr). Both must land as
...
void main() {
  ...
  group('RadarrRelease.fromJson', () {
    test('parses a torrent release with seeders and quality', () {
      final r = RadarrRelease.fromJson(releaseJson());

      expect(r.guid, 'MyIndexer-98765');
      expect(r.title, 'Movie.2024.1080p.WEB-DL.x264-GRP');
    ...
    test('normalises object-shaped rejections to a list of reason strings', () {
      ...
      final r = RadarrRelease.fromJson(json);
