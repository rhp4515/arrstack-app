...
/// @nodoc
abstract mixin class $RadarrReleaseCopyWith<$Res>  {
  factory $RadarrReleaseCopyWith(RadarrRelease value, $Res Function(RadarrRelease) _then) = _$RadarrReleaseCopyWithImpl;
@useResult
$Res call({
 String guid, String title, int size, int indexerId, String? indexer, int? seeders, int? leechers, String? protocol, RadarrQualityInfo? quality, int? qualityWeight, num? ageMinutes, bool rejected,@JsonKey(fromJson: _rejectionsFromJson) List<String> rejections, String? releaseGroup, bool downloadAllowed, int? customFormatScore
});
...
/// @nodoc
class _$RadarrReleaseCopyWithImpl<$Res>
    implements $RadarrReleaseCopyWith<$Res> {
  _$RadarrReleaseCopyWithImpl(this._self, this._then);

  final RadarrRelease _self;
  final $Res Function(RadarrRelease) _then;
...
as RadarrQualityInfo?,qualityWeight: freezed == qualityWeight ? _self.qualityWeight : qualityWeight // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [RadarrRelease].
extension RadarrReleasePatterns on RadarrRelease {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RadarrRelease value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RadarrRelease() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RadarrRelease value)  $default,){
final _that = this;
switch (_that) {
case _RadarrRelease():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RadarrRelease value)?  $default,){
final _that = this;
switch (_that) {
case _RadarrRelease() when $default != null:
return $default(_that);case _:
...
class _RadarrRelease implements RadarrRelease {
  const _RadarrRelease({this.guid = '', this.title = '', this.size = 0, this.indexerId = 0, this.indexer, this.seeders, this.leechers, this.protocol, this.quality, this.qualityWeight, this.ageMinutes, this.rejected = false, @JsonKey(fromJson: _rejectionsFromJson)  List<String> rejections = const <String>[], this.releaseGroup, this.downloadAllowed = true, this.customFormatScore}): _rejections = rejections;
  factory _RadarrRelease.fromJson(Map<String, dynamic> json) => _$RadarrReleaseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RadarrReleaseCopyWith<_RadarrRelease> get copyWith => __$RadarrReleaseCopyWithImpl<_RadarrRelease>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RadarrReleaseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RadarrRelease&&(identical(other.guid, guid) || other.guid == guid)&&(identical(other.title, title) || other.title == title)&&(identical(other.size, size) || other.size == size)&&(identical(other.indexerId, indexerId) || other.indexerId == indexerId)&&(identical(other.indexer, indexer) || other.indexer == indexer)&&(identical(other.seeders, seeders) || other.seeders == seeders)&&(identical(other.leechers, leechers) || other.leechers == leechers)&&(identical(other.protocol, protocol) || other.protocol == protocol)&&(identical(other.quality, quality) || other.quality == quality)&&(identical(other.qualityWeight, qualityWeight) || other.qualityWeight == qualityWeight)&&(identical(other.ageMinutes, ageMinutes) || other.ageMinutes == ageMinutes)&&(identical(other.rejected, rejected) || other.rejected == rejected)&&const DeepCollectionEquality().equals(other._rejections, _rejections)&&(identical(other.releaseGroup, releaseGroup) || other.releaseGroup == releaseGroup)&&(identical(other.downloadAllowed, downloadAllowed) || other.downloadAllowed == downloadAllowed)&&(identical(other.customFormatScore, customFormatScore) || other.customFormatScore == customFormatScore));
}
...
/// @nodoc
abstract mixin class _$RadarrReleaseCopyWith<$Res> implements $RadarrReleaseCopyWith<$Res> {
  factory _$RadarrReleaseCopyWith(_RadarrRelease value, $Res Function(_RadarrRelease) _then) = __$RadarrReleaseCopyWithImpl;
@override @useResult
$Res call({
 String guid, String title, int size, int indexerId, String? indexer, int? seeders, int? leechers, String? protocol, RadarrQualityInfo? quality, int? qualityWeight, num? ageMinutes, bool rejected,@JsonKey(fromJson: _rejectionsFromJson) List<String> rejections, String? releaseGroup, bool downloadAllowed, int? customFormatScore
});
...
/// @nodoc
class __$RadarrReleaseCopyWithImpl<$Res>
    implements _$RadarrReleaseCopyWith<$Res> {
  __$RadarrReleaseCopyWithImpl(this._self, this._then);

  final _RadarrRelease _self;
  final $Res Function(_RadarrRelease) _then;

/// Create a copy of RadarrRelease
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? guid = null,Object? title = null,Object? size = null,Object? indexerId = null,Object? indexer = freezed,Object? seeders = freezed,Object? leechers = freezed,Object? protocol = freezed,Object? quality = freezed,Object? qualityWeight = freezed,Object? ageMinutes = freezed,Object? rejected = null,Object? rejections = null,Object? releaseGroup = freezed,Object? downloadAllowed = null,Object? customFormatScore = freezed,}) {
  return _then(_RadarrRelease(
guid: null == guid ? _self.guid : guid // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,size: null == size ? _self.size : size // ignore: cast_nullable_to_non_nullable
as int,indexerId: null == indexerId ? _self.indexerId : indexerId // ignore: cast_nullable_to_non_nullable
